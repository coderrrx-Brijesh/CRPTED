      ...
      <div className="relative z-10">
        <div className="h-screen w-full flex justify-between px-8 pt-0">
          <div className="ml-8 flex flex-col gap-10 w-2/5 items-start justify-center">
            ...
            <button class="relative inline-flex items-center justify-center rounded-2xl  p-0.5 mb-2 me-2 overflow-hidden text-2xl font-medium text-gray-900  group bg-gradient-to-br from-purple-800 to-indigo-600 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
              <span class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-2xl group-hover:bg-opacity-0">
                Get Started Now
              </span>
            </button>
          </div>
