...
import servicesImage from "../../assets/service2.jpg";
      ...
      <div className="container max-w-7xl mx-auto px-4 py-16 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 mt-4">
            Explore the services we offer to make your crypto journey seamless
            and secure.
          </p>
        </div>
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="flex-1">
            <img
              ...
              className="rounded-lg shadow-lg w-full h-auto object-cover opacity-95"
            />
          </div>
